...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-[860px] -translate-y-3 flex-col items-center px-4 py-14 text-center sm:translate-y-0 sm:px-6 sm:py-20 lg:px-8 xl:py-14">
        <div className="animate-fade-up flex w-full flex-col items-center">
          <h1 className="max-w-5xl text-[clamp(2.25rem,10vw,2.7rem)] leading-[1.03] tracking-[-0.04em] text-innova-black sm:text-[clamp(2.6rem,6.2vw,4.85rem)] sm:leading-[1.02] sm:tracking-[-0.045em] xl:text-[clamp(2.5rem,5.1vw,4.15rem)]">
          ...
          <div className="mt-9 flex w-full max-w-[26rem] flex-row justify-center gap-2.5 sm:mt-10 sm:w-auto sm:max-w-none sm:gap-3">
            <Button
              asChild
              size="lg"
              className="h-[52px] min-w-0 flex-1 rounded-full bg-foreground px-3 text-sm font-semibold text-background shadow-none hover:bg-primary hover:text-primary-foreground min-[375px]:text-base sm:min-w-40 sm:flex-none sm:px-8 xl:h-[46px] xl:min-w-32 xl:text-sm"
            >
