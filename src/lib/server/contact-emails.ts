...
<html lang="es">
  ...
  <body style="margin:0;background:#f3f5f7;color:#15191e;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Arial,Helvetica,sans-serif;font-weight:400;">
          ...
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width:640px;background:#ffffff;border:1px solid #e3e7eb;border-radius:18px;overflow:hidden;box-shadow:0 10px 32px rgba(13,22,33,.08);">
            ...
            <tr>
              <td style="padding:24px 36px;background:#0d1115;color:#aeb7c0;font-size:12px;line-height:19px;">
                <div style="color:#ffffff;font-size:13px;font-weight:400;margin-bottom:4px;">Innova Industries America</div>
    ...
    html: emailShell(
      `<tr>
        <td style="padding:42px 36px 18px;">
          <div style="font-size:12px;line-height:18px;letter-spacing:2px;text-transform:uppercase;color:#2584d8;font-weight:400;">Solicitud recibida</div>
          <h1 style="margin:12px 0 18px;font-size:28px;line-height:37px;color:#11161b;font-weight:500;">Gracias por contactarnos</h1>
          <p style="margin:0 0 14px;font-size:16px;line-height:26px;color:#303841;font-weight:400;">Hola, ${name}.</p>
      ...
      <tr>
        <td style="padding:18px 36px 34px;">
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#f6f8fa;border:1px solid #e3e8ed;border-radius:12px;">
            <tr><td style="padding:22px 24px 8px;font-size:12px;letter-spacing:1.3px;text-transform:uppercase;color:#77818c;font-weight:400;">Resumen de tu solicitud</td></tr>
            <tr><td style="padding:10px 24px;font-size:14px;line-height:21px;color:#69737e;border-bottom:1px solid #e3e8ed;">Empresa<br><span style="color:#161b20;font-size:15px;font-weight:400;">${company}</span></td></tr>
            <tr><td style="padding:14px 24px 22px;font-size:14px;line-height:21px;color:#69737e;">Asunto<br><span style="color:#161b20;font-size:15px;font-weight:400;">${subject}</span></td></tr>
          </table>
          <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin-top:24px;">
            <tr><td style="background:#1676c7;border-radius:999px;"><a href="${siteUrl}" style="display:inline-block;padding:13px 24px;color:#ffffff;text-decoration:none;font-size:14px;font-weight:400;">Visitar nuestro sitio</a></td></tr>
          </table>
    ...
    html: emailShell(
      `<tr>
        <td style="padding:38px 36px 16px;">
          <div style="font-size:12px;line-height:18px;letter-spacing:2px;text-transform:uppercase;color:#2584d8;font-weight:400;">Nueva consulta web</div>
          <h1 style="margin:12px 0 0;font-size:27px;line-height:36px;color:#11161b;font-weight:500;">Un contacto solicita información</h1>
        </td>
      </tr>
      <tr>
        <td style="padding:12px 36px 34px;">
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#f6f8fa;border:1px solid #e3e8ed;border-radius:12px;">
            <tr><td style="padding:20px 24px 10px;font-size:14px;line-height:22px;color:#68727c;">Nombre<br><span style="color:#151a1f;font-size:16px;font-weight:400;">${name}</span></td></tr>
            <tr><td style="padding:10px 24px;font-size:14px;line-height:22px;color:#68727c;">Empresa<br><span style="color:#151a1f;font-size:16px;font-weight:400;">${company}</span></td></tr>
            <tr><td style="padding:10px 24px;font-size:14px;line-height:22px;color:#68727c;">Correo<br><a href="mailto:${email}" style="color:#1676c7;font-size:15px;font-weight:400;text-decoration:none;">${email}</a></td></tr>
            <tr><td style="padding:10px 24px 20px;font-size:14px;line-height:22px;color:#68727c;">Asunto<br><span style="color:#151a1f;font-size:16px;font-weight:400;">${subject}</span></td></tr>
          </table>
          <div style="margin-top:20px;padding:22px 24px;border-left:3px solid #2584d8;background:#ffffff;border-top:1px solid #e7ebef;border-right:1px solid #e7ebef;border-bottom:1px solid #e7ebef;border-radius:4px 12px 12px 4px;">
            <div style="font-size:12px;letter-spacing:1.2px;text-transform:uppercase;color:#77818c;font-weight:400;margin-bottom:10px;">Mensaje</div>
